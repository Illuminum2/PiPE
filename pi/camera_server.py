...
parser.add_argument("--quality", type=int, default=45, help="camera transmission quality")
...
def main():
    ...
    print(f"Camera server running on {HOST}:{PORT}")m
    ...
    try:
        while True:
            ...
            ok, jpg = cv2.imencode(".jpg", rgb, [cv2.IMWRITE_JPEG_QUALITY, QUALITY])
